  ...
  return (
    <div className="shadow-lg sticky top-0 bg-gradient-to-t from-pano-blue to-pano-dark-blue flex justify-between items-center px-12 py-5 ">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="border-2 bg-blue-700 text-2xl font-bold font-sans text-white cursor-pointer border-slate-800 rounded-full w-14 h-14 flex items-center justify-center">
          U
        </div>
      </div>
    </div>
