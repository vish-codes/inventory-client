...
const ShowNumberCount = ({ listData = {} }) => {
  ...
  return (
    <div className="flex items-center justify-center border-2 border-pano-blue sm:border-pano-blue md:border-pano-blue rounded-xl p-1 m-2 ml-6 shadow-md max-w-xs">
